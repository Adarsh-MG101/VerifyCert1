...
const Button = ({ children, onClick, type = "button", variant = "primary", className = "", disabled, ...props }) => {
    ...
    const variants = {
        primary: "bg-primary text-white shadow-xl shadow-primary/10",
        outline: "btn-outline border border-primary text-primary hover:bg-primary/5 shadow-lg shadow-primary/5",
