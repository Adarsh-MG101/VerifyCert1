        ...
        <header className="w-full border-b border-glass-border bg-slate-900/10 backdrop-blur-xl px-8 py-4 flex items-center justify-between sticky top-0 z-40">
            ...
            <div className="flex items-center space-x-5">
                ...
                <div className="relative" ref={dropdownRef}>
                    ...
                    {/* Dropdown Menu */}
                    {isProfileOpen && (
                        <div className="absolute right-0 mt-4 w-64 bg-[#070708] border border-glass-border rounded-2xl shadow-2xl backdrop-blur-2xl z-50 animate-fade-in py-2 overflow-hidden">
